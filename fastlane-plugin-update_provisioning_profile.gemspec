...
Gem::Specification.new do |spec|
  spec.name = "fastlane-plugin-update_provisioning_profile"
  spec.version = Fastlane::UpdateProvisioningProfile::VERSION
  spec.author = "Duy Nguyen"
  ...
  # spec.add_dependency "xcodeproj", "~> 1.6.0"
